        ...
        <table class="attendance-index__table">
            ...
            <tbody>
                ...
                <tr class="attendance-index__tr">
                    ...
                    <td class="attendance-index__td">
                        {{ isset($attendance->total_break_time) ? sprintf('%d:%02d', floor($attendance->total_break_time
                        / 60), $attendance->total_break_time % 60) : '' }}
                    </td>
                    <td class="attendance-index__td">
                        {{ isset($attendance->total_work_time) ? sprintf('%d:%02d', floor($attendance->total_work_time /
                        60), $attendance->total_work_time % 60) : '' }}
                    </td>
                    <td class="attendance-index__td">
